...
from constants import PERMEABILITY_PARAMETERS, KINETIC_PARAMETERS, GLYCEROL_EXTERNAL_EXPERIMENTAL, ALL_PARAMETERS
import time
...
def sample(nsamples, burn_in, nchains, acc_rate=0.8, tol=1e-8, mxsteps=int(2e4)):
    ...
    with pm.Model():
        ...
        variables = [*permeability_params, *kinetic_params, *gly_init]
