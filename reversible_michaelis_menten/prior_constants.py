...
DATA_LOG_UNIF_PARAMETER_RANGES = {'PermCellGlycerol': np.log10([1e-6, 1e-2]),
                                  ...
                                  'VmaxfDhaB': np.log10([1e2, 1e4]),
                                  'KmGlycerolDhaB': np.log10([1e-1, 1e1]),
                                  'VmaxrDhaB': np.log10([1e0, 1e2]),
                                  'KmHPADhaB': np.log10([1e0, 1e2]),

                                  'VmaxfDhaT': np.log10([1e1, 1e3]),
                                  'KmHPADhaT': np.log10([1e-2, 1e1]),
                                  'VmaxrDhaT': np.log10([1e0, 1e2]),
                                  'KmPDODhaT': np.log10([1e0, 1e2]),
