...
PLOT_PARAMETERS = [*PERMEABILITY_PARAMETERS, 'kcatfDhaB', 'KmGlycerolDhaB', 'kcatrDhaB', 'KmHPADhaB',
                    'kcatfDhaT', 'KmNADHDhaT', 'KmHPADhaT', 'kcatrDhaT', 'KmPDODhaT',  'KmNADDhaT',
                   'kcatfDhaD', 'KmNADDhaD', 'KmGlycerolDhaD', 'kcatrDhaD', 'KmDHADhaD', 'KmNADHDhaD',
                    'VmaxfDhaK', 'KmDhaK', *THERMO_PARAMETERS,
...
TIME_SPACING_HPA = 1000 # TODO: CHANGE TO 15 for _HPA.py and 5 _HPA_2.py
