...
#SBATCH --job-name=mass_action_thermo_NAD_NADH_all_%A_%a
#SBATCH --output=out/mass_action_thermo_NAD_NADH_all_out_%A_%a
#SBATCH --error=err/mass_action_thermo_NAD_NADH_all_err_%A_%a
