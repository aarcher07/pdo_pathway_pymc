...
DATA_LOG_UNIF_PARAMETER_RANGES = {'PermCellGlycerol': np.log10([1e-6, 1e-2]),
                                  ...
                                  'k2DhaT': np.log10([1e-1, 1e3]),
                                  'k3DhaT': np.log10([1e0, 1e4]),
                                  'k4DhaT': np.log10([1e-2, 1e2]),
                                  'k5DhaT': np.log10([1e0, 1e3]),
                                  ...
                                  'k5DhaD': np.log10([1e2, 1e3]),
                                  'k6DhaD': np.log10([1e-2, 1e2]),
                                  'k7DhaD': np.log10([1e-4, 1e0]),
                                  'KeqDhaD': np.log10([1e-6, 1e-3]),
                                  #
                                  # 'k1DhaB': np.log10([1e-5,1e5]),
                                  # 'k2DhaB': np.log10([1e-5,1e5]),
                                  # 'k3DhaB': np.log10([1e-5,1e5]),
                                  # 'KeqDhaB': np.log10([1e7, 1e8]),
                                  #
                                  # 'k1DhaT': np.log10([1e-5,1e5]),
                                  # 'k2DhaT': np.log10([1e-5,1e5]),
                                  # 'k3DhaT': np.log10([1e-5,1e5]),
                                  # 'k4DhaT': np.log10([1e-5,1e5]),
                                  # 'k5DhaT': np.log10([1e-5,1e5]),
                                  # 'k6DhaT': np.log10([1e-5,1e5]),
                                  # 'k7DhaT': np.log10([1e-5,1e5]),
                                  # 'KeqDhaT': np.log10([1e2, 1e5]),
                                  #
                                  # 'k1DhaD': np.log10([1e-5,1e5]),
                                  # 'k2DhaD': np.log10([1e-5,1e5]),
                                  # 'k3DhaD': np.log10([1e-5,1e5]),
                                  # 'k4DhaD': np.log10([1e-5,1e5]),
                                  # 'k5DhaD': np.log10([1e-5,1e5]),
                                  # 'k6DhaD': np.log10([1e-5,1e5]),
                                  # 'k7DhaD': np.log10([1e-5,1e5]),
                                  # 'KeqDhaD': np.log10([1e-6, 1e-3]),
                                  #
                                  'k1E0': np.log10([1e-2, 1e2]),
                                  'k2E0': np.log10([1e-2, 1e2]),
                                  'k3E0': np.log10([1e-2, 1e2]),
                                  'k4E0': np.log10([1e-2, 1e2]),
                                  # 'VmaxfDhaK': np.log10([1e-3, 1e3]),
                                  # 'KmDhaK': np.log10([1e-2,1e2]),
                                  'VmaxfDhaK': np.log10([1e0*0.1, 1e1*10]),
                                  'KmDhaK': np.log10([1e-3,1e-1]),

                                  'DHAB_INIT': np.log10([1e-3,1e1]),
                                  'DHAT_INIT': np.log10([1e-3, 1e1]),
                                  'DHAD_INIT': np.log10([1e-3, 1e1]),
                                  'E0_INIT': np.log10([1e-3, 1e1]),

                                  'NADH_NAD_TOTAL_INIT': np.log10([0.1, 1e1]),
                                  'NADH_NAD_RATIO_INIT': np.log10([0.1, 1e0])
                                  }
