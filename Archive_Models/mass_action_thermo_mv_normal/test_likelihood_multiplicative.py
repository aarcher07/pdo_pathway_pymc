...
import numpy as np
import time
from likelihood_multiplicative_noise_funcs_fwd import likelihood_fwd, likelihood_derivative_fwd
from likelihood_multiplicative_noise_funcs_adj import likelihood_adj, likelihood_derivative_adj
from plot_nuts_results_funcs import joint_Keq_distribution
...
#
# gly_init_val = param_sample[N_MODEL_PARAMETERS:(N_MODEL_PARAMETERS)]
...
file_name = '2022_07_02_00_27_36_658645.nc'
