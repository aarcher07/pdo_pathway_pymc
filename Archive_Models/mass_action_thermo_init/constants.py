...
DEV_PARAMETERS_LIST = [*MODEL_CONSTANTS, *INIT_CONSTANTS] # TODO change to INIT_CONSTANTS[:-1]
...
ALL_PARAMETERS = [*PERMEABILITY_PARAMETERS, *KINETIC_PARAMETERS, *ENZYME_CONCENTRATIONS, *GLYCEROL_EXTERNAL_EXPERIMENTAL]
