...
DATA_LOG_UNIF_PARAMETER_RANGES = {'PermCellGlycerol': np.log10([1e-6, 1e-2]),
                                  ...
                                  'kcatfMetab': np.log10([1e2, 1e4]),
                                  'KmMetabG': np.log10([1e-3,1e-1]),
                                  }

DATA_LOG_UNIF_ENZ_RANGES = {'DHAB_INIT_50': np.log10([0.1, 1e1]),
'DHAB_INIT_60': np.log10([0.1, 1e1]),
'DHAB_INIT_70': np.log10([0.1, 1e1]),
'DHAB_INIT_80': np.log10([0.1, 1e1]),
                            'DHAT_INIT_50': np.log10([0.1, 1e1]),
'DHAT_INIT_60': np.log10([0.1, 1e1]),
'DHAT_INIT_70': np.log10([0.1, 1e1]),
'DHAT_INIT_80': np.log10([0.1, 1e1]),
                            'E0_Metab_50': np.log10([0.1, 1e1]),
'E0_Metab_60': np.log10([0.1, 1e1]),
'E0_Metab_70': np.log10([0.1, 1e1]),
'E0_Metab_80': np.log10([0.1, 1e1])}
...
LOG_UNIF_PRIOR_SINGLE_EXP[50] = np.array([*list(DATA_LOG_UNIF_PARAMETER_RANGES.values()),
                                          DATA_LOG_UNIF_ENZ_RANGES['DHAB_INIT_50'],
                                          DATA_LOG_UNIF_ENZ_RANGES['DHAT_INIT_50'],
                                          DATA_LOG_UNIF_ENZ_RANGES['E0_Metab_50'],
...
LOG_UNIF_PRIOR_SINGLE_EXP[60] = np.array([*list(DATA_LOG_UNIF_PARAMETER_RANGES.values()),
                                          DATA_LOG_UNIF_ENZ_RANGES['DHAB_INIT_60'],
                                          DATA_LOG_UNIF_ENZ_RANGES['DHAT_INIT_60'],
                                          DATA_LOG_UNIF_ENZ_RANGES['E0_Metab_60'],
...
LOG_UNIF_PRIOR_SINGLE_EXP[70] = np.array([*list(DATA_LOG_UNIF_PARAMETER_RANGES.values()),
                                          DATA_LOG_UNIF_ENZ_RANGES['DHAB_INIT_70'],
                                          DATA_LOG_UNIF_ENZ_RANGES['DHAT_INIT_70'],
                                          DATA_LOG_UNIF_ENZ_RANGES['E0_Metab_70'],
...
LOG_UNIF_PRIOR_SINGLE_EXP[80] = np.array([*list(DATA_LOG_UNIF_PARAMETER_RANGES.values()),
                                          DATA_LOG_UNIF_ENZ_RANGES['DHAB_INIT_80'],
                                          DATA_LOG_UNIF_ENZ_RANGES['DHAT_INIT_80'],
                                          DATA_LOG_UNIF_ENZ_RANGES['E0_Metab_80'],
...
LOG_UNIF_PRIOR_ALL_EXP = np.array([*list(DATA_LOG_UNIF_PARAMETER_RANGES.values()),
                                   *list(DATA_LOG_UNIF_ENZ_RANGES.values()),
                                   *list(LOG_UNIF_G_EXT_INIT_PRIOR_PARAMETERS.values()),
                                   *list(LOG_UNIF_DCW_PRIOR_PARAMETERS_50.values()),
                                   *list(LOG_UNIF_DCW_PRIOR_PARAMETERS_60.values()),
                                   *list(LOG_UNIF_DCW_PRIOR_PARAMETERS_70.values()),
                                   *list(LOG_UNIF_DCW_PRIOR_PARAMETERS_80.values())])
...
# enz normal parameters
LOG_NORM_ENZ_PRIOR_MEAN = {key: np.mean(val) for (key,val) in DATA_LOG_UNIF_ENZ_RANGES.items()}
LOG_NORM_ENZ_PRIOR_STD = {param_name: (DATA_LOG_UNIF_ENZ_RANGES[param_name][1]
                                         -np.mean(DATA_LOG_UNIF_ENZ_RANGES[param_name]))/2
                            for param_name in DATA_LOG_UNIF_ENZ_RANGES.keys()}
LOG_NORM_ENZ_PRIOR_PARAMETERS = {param_name: [LOG_NORM_ENZ_PRIOR_MEAN[param_name],
                                                LOG_NORM_ENZ_PRIOR_STD[param_name]]
                                   for param_name in DATA_LOG_UNIF_ENZ_RANGES.keys()}
...
for gly_cond in [50,60,70,80]:
    NORM_PRIOR_MEAN_SINGLE_EXP[gly_cond] = np.array([*list(LOG_NORM_MODEL_PRIOR_MEAN.values()),
                                                     LOG_NORM_ENZ_PRIOR_MEAN['DHAB_INIT_' + str(gly_cond)],
                                                     LOG_NORM_ENZ_PRIOR_MEAN['DHAT_INIT_' + str(gly_cond)],
                                                     LOG_NORM_ENZ_PRIOR_MEAN['E0_Metab_' + str(gly_cond)],
    ...
    NORM_PRIOR_STD_RT_SINGLE_EXP[gly_cond] = np.diag([*list(LOG_NORM_MODEL_PRIOR_STD.values()),
                                                     LOG_NORM_ENZ_PRIOR_STD['DHAB_INIT_' + str(gly_cond)],
                                                     LOG_NORM_ENZ_PRIOR_STD['DHAT_INIT_' + str(gly_cond)],
                                                     LOG_NORM_ENZ_PRIOR_STD['E0_Metab_' + str(gly_cond)],
...
NORM_PRIOR_PARAMETER_ALL_EXP_DICT = {**LOG_NORM_MODEL_PRIOR_PARAMETERS,
                                     **LOG_NORM_ENZ_PRIOR_PARAMETERS,
                                     **NORM_G_EXT_INIT_PRIOR_PARAMETERS,
...
NORM_PRIOR_MEAN_ALL_EXP = np.array([*list(LOG_NORM_MODEL_PRIOR_MEAN.values()),
                                    *list(LOG_NORM_ENZ_PRIOR_MEAN.values()),
...
NORM_PRIOR_STD_RT_ALL_EXP = np.diag([*list(LOG_NORM_MODEL_PRIOR_STD.values()),
                                     *list(LOG_NORM_ENZ_PRIOR_STD.values()),
