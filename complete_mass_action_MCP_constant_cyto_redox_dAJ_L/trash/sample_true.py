...
def sample_true(nsamples, burn_in, nchains, acc_rate=0.8, fwd_rtol=1e-8, fwd_atol=1e-8, bck_rtol=1e-4, bck_atol=1e-4,
           fwd_mxsteps=int(1e5),bck_mxsteps=int(1e5), init = 'jitter+adapt_diag', initvals = None, random_seed = None):
    # use PyMC to sampler from log-likelihood

    logl = LogLike(likelihood_adj_true, fwd_rtol=fwd_rtol, fwd_atol=fwd_atol, bck_rtol=bck_rtol, bck_atol=bck_atol,
...
if __name__ == '__main__':
    ...
    idata_nuts = sample_true(nsamples, burn_in, nchains, acc_rate=acc_rate, fwd_rtol=fwd_rtol, fwd_atol=fwd_atol,
