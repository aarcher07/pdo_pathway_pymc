...
def RHS_dD(t, x, params):
    ...
    VmaxfGlpK = 10 ** params.VmaxfGlpK_dD  # TODO: CHANGE
    KmGlpK = 10 ** params.KmGlpK_dD

    nMCPs = 10 ** params.nMCPs
    ...
    mcp_surface_area_mcp_volume = MCP_SURFACE_AREA / MCP_VOLUME
    mcp_surface_area_cell_volume = MCP_SURFACE_AREA / CELL_VOLUME
    ...
    d['G_CYTO'] = - cell_area_cell_volume * PermCellGlycerol * (x.G_CYTO - x.G_EXT) \
                  - nMCPs * mcp_surface_area_cell_volume * PermMCPGlycerol * (x.G_CYTO - x.G_MCP) \
                  - R_GlpK

    d['H_CYTO'] = - cell_area_cell_volume * PermCell3HPA * (x.H_CYTO - x.H_EXT) \
                  - nMCPs * mcp_surface_area_cell_volume * PermMCP3HPA * (x.H_CYTO - x.H_MCP)
...
problem_dD = sunode.symode.SympyProblem(
