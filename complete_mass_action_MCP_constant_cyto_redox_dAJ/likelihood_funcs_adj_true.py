...
def likelihood_adj_true(params, fwd_rtol = 1e-8, fwd_atol=1e-8, fwd_mxsteps=int(1e4)):
    ...
    try:
        ...
        lik_curr = -0.5*((TIME_SERIES_MEAN[exp_cond] - yout[::TIME_SPACING, DATA_INDEX])/TIME_SERIES_STD[exp_cond])**2
...
def likelihood_derivative_adj_true(params, fwd_rtol = 1e-8, fwd_atol=1e-8,
