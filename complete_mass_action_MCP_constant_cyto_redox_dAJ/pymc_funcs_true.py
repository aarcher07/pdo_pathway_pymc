...
from likelihood_funcs_adj_true import likelihood_adj_true, likelihood_derivative_adj_true  #TODO : change to _3HPA
...
class LogLikeTrue(at.Op):
    ...
    def __init__(self, likelihood, fwd_rtol = 1e-8, fwd_atol = 1e-8,
        ...
        self.logpgrad = LogLikeGradTrue(fwd_rtol=self.fwd_rtol, fwd_atol = self.fwd_atol, bck_rtol=self.bck_rtol,
...
class LogLikeGradTrue(at.Op):
    ...
    def perform(self, node, inputs, outputs):
        (params,) = inputs
        # calculate gradients
        grads = likelihood_derivative_adj_true(params, fwd_rtol=self.fwd_rtol, fwd_atol=self.fwd_atol,
