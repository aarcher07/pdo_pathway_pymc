...
param_sample = np.array([*CELL_PERMEABILITY_MEAN.values(),
                         ...
                         *list(OD_PRIOR_PARAMETERS_MEAN['AJ-L'].values())
                         ])
...
for var in VARIABLE_NAMES:
    y0[var] = 0
y0['G_EXT'] = TIME_SERIES_MEAN['AJ-L']['glycerol'][0]
y0['G_CYTO'] = TIME_SERIES_MEAN['AJ-L']['glycerol'][0]
y0['G_MCP'] = TIME_SERIES_MEAN['AJ-L']['glycerol'][0]
y0['H_EXT'] = TIME_SERIES_MEAN['AJ-L']['3-HPA'][0]
y0['H_CYTO'] = TIME_SERIES_MEAN['AJ-L']['3-HPA'][0]
y0['H_MCP'] = TIME_SERIES_MEAN['AJ-L']['3-HPA'][0]
y0['P_EXT'] = TIME_SERIES_MEAN['AJ-L']['13PD'][0]
y0['P_CYTO'] = TIME_SERIES_MEAN['AJ-L']['13PD'][0]
y0['P_MCP'] = TIME_SERIES_MEAN['AJ-L']['13PD'][0]
...
sens0[PARAMETER_LIST.index('nPduCDE'), VARIABLE_NAMES.index('PduCDE')] = np.log(10)*(10**param_sample[PARAMETER_LIST.index('nPduCDE')])/(Avogadro * POLAR_VOLUME)
sens0[PARAMETER_LIST.index('nPduP'), VARIABLE_NAMES.index('PduP')] = np.log(10)*(10**param_sample[PARAMETER_LIST.index('nPduP')])/(Avogadro * POLAR_VOLUME)
sens0[PARAMETER_LIST.index('nPduQ'), VARIABLE_NAMES.index('PduQ')] = np.log(10)*(10**param_sample[PARAMETER_LIST.index('nPduQ')])/(Avogadro * POLAR_VOLUME)
sens0[PARAMETER_LIST.index('nPduL'), VARIABLE_NAMES.index('PduL')] = np.log(10)*(10**param_sample[PARAMETER_LIST.index('nPduL')])/(Avogadro * POLAR_VOLUME)
...
sens0[PARAMETER_LIST.index('AJ_radius'), 'PduCDE'] = -3*param_sample[PARAMETER_LIST.index('nMCPs')]*(10**param_sample[PARAMETER_LIST.index('nPduCDE')])/(Avogadro * POLAR_VOLUME)
sens0[PARAMETER_LIST.index('AJ_radius'), 'PduP'] = -3*param_sample[PARAMETER_LIST.index('nMCPs')]*(10**param_sample[PARAMETER_LIST.index('nPduP')])/(Avogadro * POLAR_VOLUME)
sens0[PARAMETER_LIST.index('AJ_radius'), 'PduQ'] = -3*param_sample[PARAMETER_LIST.index('nMCPs')]*(10**param_sample[PARAMETER_LIST.index('nPduQ')])/(Avogadro * POLAR_VOLUME)
sens0[PARAMETER_LIST.index('AJ_radius'), 'PduL'] = -3*param_sample[PARAMETER_LIST.index('nMCPs')]*(10**param_sample[PARAMETER_LIST.index('nPduL')])/(Avogadro * POLAR_VOLUME)

sens0[PARAMETER_LIST.index('nMCPs'), 'PduCDE'] = (10**param_sample[PARAMETER_LIST.index('nPduCDE')])/(Avogadro * POLAR_VOLUME)
sens0[PARAMETER_LIST.index('nMCPs'), 'PduP'] = (10**param_sample[PARAMETER_LIST.index('nPduP')])/(Avogadro * POLAR_VOLUME)
sens0[PARAMETER_LIST.index('nMCPs'), 'PduQ'] = (10**param_sample[PARAMETER_LIST.index('nPduQ')])/(Avogadro * POLAR_VOLUME)
sens0[PARAMETER_LIST.index('nMCPs'), 'PduL'] = (10**param_sample[PARAMETER_LIST.index('nPduL')])/(Avogadro * POLAR_VOLUME)
...
print(yout.view(problem.state_dtype)['PduW'] + yout.view(problem.state_dtype)['PduW_C'])
