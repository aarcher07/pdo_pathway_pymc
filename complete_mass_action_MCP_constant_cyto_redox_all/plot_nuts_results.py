...
# plot_loglik_individual(samples.sample_stats.lp, plot_file_location, post_nchains)
# plot_loglik_overlay(samples.sample_stats.lp, plot_file_location, post_nchains)
plot_time_series_distribution(samples, plot_file_location, nchains, fwd_atol, fwd_rtol, mxsteps)
# plot_corr(samples, plot_file_location, post_nchains)
# plot_corr_scatter(samples, plot_file_location, post_nchains)
# KeqDhaB = np.power(10,samples.posterior.KeqDhaB)
# KeqDhaT = np.power(10,samples.posterior.KeqDhaT)
# joint_Keq_distribution(KeqDhaB, KeqDhaT, plot_file_location, post_nchains)
